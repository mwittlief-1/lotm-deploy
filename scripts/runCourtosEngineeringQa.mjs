...
const commands = [
  ...
  { name: "foundation-a-build", command: nodeBinary, args: ["node_modules/tsx/dist/cli.mjs", "scripts/buildCourtosFoundationARelease.mts"] },
  { name: "foundation-a-release", command: nodeBinary, args: ["node_modules/tsx/dist/cli.mjs", "scripts/verifyCourtosFoundationARelease.mts"] },
  ...
  { name: "bundle-budget", command: nodeBinary, args: ["scripts/verifyCourtosBundleBudget.mjs"] },
