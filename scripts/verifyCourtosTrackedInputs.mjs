...
const REQUIRED_REPOSITORY_INPUTS = [
  ...
  "scripts/verifyCourtosDesktopDistribution.mjs",
  "scripts/auditCourtosDesktopSize.mjs",
  "scripts/preflightCourtosDesktopExternalBuild.mjs",
  "scripts/prepareCourtosSteamPipe.mjs",
  "scripts/reportCourtosWindowsPackagingReadiness.mjs",
  "scripts/runCourtosDesktopInstallSmoke.mjs",
  "scripts/runCourtosDesktopFirstReleaseUat.mjs",
  "scripts/verifyCourtosScribePerformanceReport.mjs",
  "scripts/verifyCourtosRoomAssets.mjs",
  "qa/desktop/first-release-uat.v1.json",
  ...
  "public/assets/council-command-room/command-surfaces/family-tree.png",
  "public/assets/council-command-room/command-surfaces/orders-board.png",
