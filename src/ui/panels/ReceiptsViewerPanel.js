    ...
    return (_jsxs("div", { style: { display: "grid", gap: 14 }, children: [scopeLabel || scopeSummary ? (_jsxs("div", { "data-receipts-scope": "true", style: {
                    ...
                    : "Phase record is secondary evidence. Use it when the drilldown still leaves questions about the exact per-phase receipt trail." }), mode === "grouped" ? (_jsxs("div", { style: { display: "grid", gap: 12 }, children: [counterpartySections.length ? (_jsxs("section", { "data-receipts-counterparties": "true", style: {
                            ...
                            ...PLAY_SCREEN_SUBCARD_STYLE
                                            ...
                                            background: "#fcfaf5",
                                            border: "1px solid rgba(172, 143, 100, 0.24)"
                                        }, children: [_jsxs("div", { style: { display: "flex", justifyContent: "space-between", gap: 10, alignItems: "baseline", flexWrap: "wrap" }, children: [_jsx("div", { style: { fontWeight: 700 }, children: row.label }), _jsx("div", { style: { fontSize: 12, fontWeight: 700 }, children: row.amountLabel })] }), _jsx("div", { style: { fontSize: 12, opacity: 0.82, marginTop: 6 }, children: row.summary })] }, row.id)))] })) : null, section.auditRows.length ? (_jsxs("div", { style: { display: "grid", gap: 8, marginTop: 12 }, children: [_jsx("div", { style: { fontSize: 11, letterSpacing: 0.4, opacity: 0.66, textTransform: "uppercase" }, children: "Audit detail" }), section.auditRows.map((row) => (_jsxs("div", { "data-receipts-audit-row": row.id, style: {
                                            padding: 10,
                                            borderRadius: 12,
                                            background: "#fff",
                                            border: "1px solid rgba(172, 143, 100, 0.24)"
                                        }, children: [_jsxs("div", { style: { display: "flex", justifyContent: "space-between", gap: 10, alignItems: "baseline", flexWrap: "wrap" }, children: [_jsx("div", { style: { fontWeight: 700 }, children: row.label }), _jsx("div", { style: { fontSize: 11, opacity: 0.72 }, children: row.statusLabel })] }), _jsxs("div", { style: { display: "grid", gap: 8, gridTemplateColumns: "repeat(auto-fit, minmax(140px, 1fr))", marginTop: 8 }, children: [_jsxs("div", { children: [_jsx("div", { style: { fontSize: 11, letterSpacing: 0.4, opacity: 0.66, textTransform: "uppercase" }, children: "Receipts" }), _jsx("div", { style: { marginTop: 4 }, children: row.receiptLabel })] }), _jsxs("div", { children: [_jsx("div", { style: { fontSize: 11, letterSpacing: 0.4, opacity: 0.66, textTransform: "uppercase" }, children: "Walkdown" }), _jsx("div", { style: { marginTop: 4 }, children: row.walkdownLabel })] })] }), _jsx("div", { style: { fontSize: 12, opacity: 0.82, marginTop: 8 }, children: row.detail })] }, row.id)))] })) : null, section.highlights.length ? (_jsx("div", { style: { display: "grid", gap: 8, marginTop: 12 }, children: section.highlights.map((highlight) => (_jsxs("div", { style: {
                                        padding: 10,
                                        borderRadius: 12,
                                        background: "#fcfaf5",
                                        border: "1px solid rgba(172, 143, 100, 0.24)"
