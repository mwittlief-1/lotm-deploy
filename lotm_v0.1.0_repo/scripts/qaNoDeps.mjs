...
// Determinism seeds: load if present
let goldenSeeds = [];
try {
  const gsPath = path.resolve("docs/golden_seeds_v0.0.9.json");
...
function checkBoundedSnapshot(entry) {
  const allowed = new Set(["turn_index","manor","house","relationships","flags","game_over"]);
