...
- total manor count target used by the algorithm: `447`
...
- known caveats: county IDs are derived from the legacy county overlay in map_v1.json when present; elite_complex_count counts only final elite seat complexes; elite_sites.csv includes elite complexes plus strategic rural seat nodes (121 vs 146); oversized_splits_attempted is 96; count is persisted directly from the split pass
